<x-layout>
    ...
    <div class="container col-12 mt-5">
        <div class="row">
            <div class="col-4 col-md-4 card-header">
                <div class="card1 card" style="width: 18rem;">
                    <div class="card-body">
                        ...
                        <a href="/chisiamo" class="he-li mx-3">Scopri di più</a>
                    </div>
                </div>
            </div>
            <div class="col-4 col-md-4 card-header">
            ...
            <div class="col-4 col-md-4 card-header">
                <div class="card3 card" style="width: 18rem;">
                    <div class="card-body">
                        <h4 class="card-title mb-2">Orari di apertura</h4>
                        <ul class="card-text">
                            <li>
    ...
    <div class="col-12 mt-5 container-fluid">
        <div class="row">
            <div class="review">
                <h1 class="mt-5 col-1 mx-5 text-light"> Cosa dicono i nostri clienti </h1>
                {{-- card-carousel --}}
            </div>
        </div>
    </div>
